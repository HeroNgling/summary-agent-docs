...
{/* TODO: GIF — click Start a Meeting → show dropdown with Record Now / Upload options → select Record Now → recording starts */}
{/* <Frame caption="Start a manual recording in two clicks"> ![Start a Meeting](/images/recording-start.gif) </Frame> */}
...
{/* TODO: GIF — show a Teams/Zoom call with the Fano bot joining and appearing in the participant list */}
{/* <Frame caption="The Fano note-taker bot joins as a visible participant"> ![Bot joining](/images/recording-bot-joins.gif) </Frame> */}
