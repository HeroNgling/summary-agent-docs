...
Fano Memos gives you two ways to record a meeting: **automatic** (via calendar sync) and **manual** (Record Now). Both produce the same result — a full transcript, AI summary, and audio playback.
