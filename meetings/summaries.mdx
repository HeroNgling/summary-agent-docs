...
{/* TODO: GIF — open a meeting → scroll through the summary showing overview, key topics, decisions, action items */}
{/* <Frame caption="AI-generated summary with decisions and action items"> ![Meeting summary](/images/summaries-scroll.gif) </Frame> */}
...
{/* TODO: GIF — click template dropdown → select a different template → summary regenerates */}
{/* <Frame caption="Switch templates and the summary regenerates instantly"> ![Switching templates](/images/summaries-template-switch.gif) </Frame> */}
